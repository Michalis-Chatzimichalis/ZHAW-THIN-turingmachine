...
public class Turingmachine {
    ...
    private void loadInput(String input) {
        ...
        if (input.matches("[01ICDWX_]*")) {
            tapeInput = input;
            System.out.println("Using symbolic input: '" + input + "'");
        } else {
            try {
                ...
                throw new IllegalArgumentException("Input must be a binary string, a symbolic string (e.g., 'IC'), or a non-negative decimal integer. Invalid input: " + input);
            }
        }
    ...
    public static void main(String[] args) {
        ...
        String tmSource = ""; // Aufgabe 2
